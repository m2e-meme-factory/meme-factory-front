            ...
            {!isSubmitedVideo ? (
              ...
              <Flex direction='column' gap='2'>
                ...
                >
                  ...
                  <Callout.Text>Video was uploaded</Callout.Text>
                </Callout.Root>
              </Flex>
            )}
          </Step>
          ...
          >
            {fileId && !loading && (
              <Flex direction='column' gap='4'>
                ...
                <Callout.Root color='gray'>Join Meme to Earn - link in account bio</Callout.Root>
                <Button
                  onClick={() => handleCopyText('Join Meme to Earn - link in account bio')}
                  color='gray'
                  size='3'
                >
                  {copyText}
          ...
          >
            <Flex direction='column' gap='4'>
              ...
              <Callout.Root color='red'>
                ...
                <Callout.Text>
                  Wait until it gets as many views as possible, because you can send video only
                  once.
                </Callout.Text>
              </Callout.Root>
            </Flex>
