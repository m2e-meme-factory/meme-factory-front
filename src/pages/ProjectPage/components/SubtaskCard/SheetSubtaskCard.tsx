    ...
    <Card asChild className='SubtaskCard' onClick={handleDialogOpen}>
      <Box p='2'>
        <Flex align='center' justify='between' pl='2' pr='2'>
          ...
          <Sheet isOpen={isModalVisible} onClose={() => handleDialogClose()} style={{zIndex: 2}}>
              <Sheet.Container>
                <Sheet.Header />
                <Sheet.Content>
                  <Theme style={{ width: '100%' }} appearance='dark'>
                            ...
                            <Form.Root className='FormRoot' onSubmit={handleSubmit}>
                              <Form.Field className='FormField' name='cover-letter'>
                                ...
                                <Form.Control asChild>
                                  <textarea style={{minHeight: "52px"}} placeholder='Write data, that is required by task description' className='Textarea' required />
                                </Form.Control>
