            ...
            <Dialog.Description>
                <Flex mt='5' direction='column'>
                    ...
                    <Text>
                        ...
                        <Button variant="ghost"  onClick={handleToggleDescription} style={{ marginLeft: '8px', color: '#fecf0a' }}>
                            {isDescVisible ? "View Less" : "View More"}
                        </Button>
                    </Text>
                    <Text className='Price'><span className='TextAccent'>Price:</span> {price}$</Text>
                </Flex>
            </Dialog.Description>
        </>
    )
