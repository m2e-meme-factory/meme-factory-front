export enum LOCAL_TEXT {
  ...
  BECOME_PART_MEME_FACTORY_DISCORD_CHANNEL = 'become_part_meme_factory_discord_channel',
  BECOME_PART_MEME_FACTORY_TELEGRAM_CHANNEL = 'become_part_meme_factory_telegram_channel',
  BRONZE = 'bronze',
  BUY = 'buy',
  CANCEL = 'cancel',
  CLAIM = 'claim',
  CLIMED = 'claimed',
  CLAIM_ONE_DAY = 'claim_one_day',
  ...
  ENGLISH = 'english',
  ENTER_LINK_VIDEO = 'enter_link_video',
  ...
  GET_REWARDED_VISITING_WEBSITE = 'get_rewarded_visiting_website',
  ...
  SERVICE_NOT_WORK_STABLY = 'service_not_work_stably',
  SILVER = 'silver',
  SHARE = 'share',
  SHARE_IN_STORIES = 'share_in_stories',
  SHARE_STORY_YOUR_INSTAGRAM_ACCOUNT_INVITE_LINK = 'share_story_your_instagram_account_invite_link',
  SHARE_YOUR_REF_LINK = 'share_your_ref_link',
  SHOW_YOUR_SUPPORT_LIKING_POST_REDDIT = 'show_your_support_liking_post_reddit',
  ...
  STAY_UPDATED_NEWS_ON_X = 'stay_updated_news_on_x',
  SUBMITTING_APPLICATION = 'submitting_application',
  SUBSCRIBE_TIKTOK_CHANNEL_PART_GROWING_AUDIENCE = 'subscribe_tiktok_channel_part_growing_audience',
  SUBSCRIBE_YOUTUBE_CHANNEL_PART_GROWING_AUDIENCE = 'subscribe_youtube_channel_part_growing_audience',
