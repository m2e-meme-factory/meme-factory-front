export const navigationRoutes = [
  {
    ...
    path: '/profile',
    icon: (
      // <svg xmlns='http://www.w3.org/2000/svg' height='2rem' viewBox='0 0 256 256'>
