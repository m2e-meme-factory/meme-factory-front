    ...
    subtasks: [
        {
            ...
            description: 'Create low-fidelity wireframes to outline the basic structure of the landing page.',
            price: 50,
        },
        {
            id: 2,
            title: 'Design Mockups',
            description: 'Design high-fidelity mockups in Figma, incorporating feedback from the wireframe stage.',
            price: 100,
        },
        {
            id: 3,
