...
export function loadUnlockMyWallet(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3955656361) { throw Error('Invalid prefix'); }
...
export function loadUnlockMe(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 238808378) { throw Error('Invalid prefix'); }
...
export function loadChangeWalletStatus(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3398027824) { throw Error('Invalid prefix'); }
    let _wallet_owner = sc_0.loadAddress();
    let _newStatus = sc_0.loadBit();
    return { $$type: 'ChangeWalletStatus' as const, wallet_owner: _wallet_owner, newStatus: _newStatus };
}
...
export function loadWalletOrder(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 954660261) { throw Error('Invalid prefix'); }
    let _newStatus = sc_0.loadBit();
...
export function loadMintClose(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 3040496651) { throw Error('Invalid prefix'); }
...
export function loadJettonWallet$Data(slice: Slice) {
    ...
    return { $$type: 'JettonWallet$Data' as const, balance: _balance, owner: _owner, master: _master, sendingEnabled: _sendingEnabled };
}
...
export function loadJettonMaster$Data(slice: Slice) {
    ...
    return { $$type: 'JettonMaster$Data' as const, total_supply: _total_supply, owner: _owner, content: _content, mintable: _mintable, publicUnlock: _publicUnlock };
}
...
export function loadPlanInfo(slice: Slice) {
    ...
    return { $$type: 'PlanInfo' as const, price_per_token: _price_per_token, tokens_amount: _tokens_amount, min_amount: _min_amount };
}
...
export function loadSetPlan(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 4091319390) { throw Error('Invalid prefix'); }
...
export function loadRemovePlan(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1826455974) { throw Error('Invalid prefix'); }
    let _plan_seqno = sc_0.loadUintBig(8);
...
export function loadWithdrawFromPlan(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1990978068) { throw Error('Invalid prefix'); }
    let _plan_seqno = sc_0.loadUintBig(8);
    let _amount = sc_0.loadCoins();
...
export function loadStart(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2718406916) { throw Error('Invalid prefix'); }
...
export function loadDrainAll(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 1051056026) { throw Error('Invalid prefix'); }
...
export function loadWithdrawUsdt(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2882846) { throw Error('Invalid prefix'); }
    let _amount = sc_0.loadCoins();
...
export function loadWithdrawTokensForce(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 581355449) { throw Error('Invalid prefix'); }
    let _amount = sc_0.loadCoins();
...
export function loadPublickUnlockState(slice: Slice) {
    let sc_0 = slice;
    if (sc_0.loadUint(32) !== 2953017186) { throw Error('Invalid prefix'); }
...
export function loadPresaleMaster$Data(slice: Slice) {
    ...
    return { $$type: 'PresaleMaster$Data' as const, owner: _owner, stopped: _stopped, my_jetton_wallet: _my_jetton_wallet, my_usdt_wallet: _my_usdt_wallet, plans: _plans };
}
...
function loadTuplePresaleMaster$Data(source: TupleReader) {
    ...
    let _plans = Dictionary.loadDirect(Dictionary.Keys.Uint(8), dictValueParserPlanInfo(), source.readCellOpt());
    return { $$type: 'PresaleMaster$Data' as const, owner: _owner, stopped: _stopped, my_jetton_wallet: _my_jetton_wallet, my_usdt_wallet: _my_usdt_wallet, plans: _plans };
}
...
function storeTuplePresaleMaster$Data(source: PresaleMaster$Data) {
    ...
    builder.writeCell(source.plans.size > 0 ? beginCell().storeDictDirect(source.plans, Dictionary.Keys.Uint(8), dictValueParserPlanInfo()).endCell() : null);
    return builder.build();
}
...
async function JettonWallet_init(owner: Address, master: Address) {
    const __code = Cell.fromBase64('');
    const __system = Cell.fromBase64('');
...
const JettonWallet_types: ABIType[] = [
    ...
    {"name":"ChangeWalletStatus","header":3398027824,"fields":[{"name":"wallet_owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"newStatus","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"WalletOrder","header":954660261,"fields":[{"name":"newStatus","type":{"kind":"simple","type":"bool","optional":false}}]},
    ...
    {"name":"JettonWallet$Data","header":null,"fields":[{"name":"balance","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"master","type":{"kind":"simple","type":"address","optional":false}},{"name":"sendingEnabled","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"JettonMaster$Data","header":null,"fields":[{"name":"total_supply","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"content","type":{"kind":"simple","type":"cell","optional":false}},{"name":"mintable","type":{"kind":"simple","type":"bool","optional":false}},{"name":"publicUnlock","type":{"kind":"simple","type":"bool","optional":false}}]},
    ...
    {"name":"PlanInfo","header":null,"fields":[{"name":"price_per_token","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"tokens_amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}},{"name":"min_amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"SetPlan","header":4091319390,"fields":[{"name":"plan_seqno","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"new_plan","type":{"kind":"simple","type":"PlanInfo","optional":false}}]},
    {"name":"RemovePlan","header":1826455974,"fields":[{"name":"plan_seqno","type":{"kind":"simple","type":"uint","optional":false,"format":8}}]},
    {"name":"TopUpPlan","header":null,"fields":[{"name":"plan_seqno","type":{"kind":"simple","type":"uint","optional":false,"format":8}}]},
    {"name":"WithdrawFromPlan","header":1990978068,"fields":[{"name":"plan_seqno","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"BuyTokens","header":null,"fields":[{"name":"plan_seqno","type":{"kind":"simple","type":"uint","optional":false,"format":8}},{"name":"receiver","type":{"kind":"simple","type":"address","optional":false}}]},
    {"name":"Stop","header":4227166658,"fields":[]},
    {"name":"Start","header":2718406916,"fields":[]},
    {"name":"DrainAll","header":1051056026,"fields":[]},
    {"name":"WithdrawUsdt","header":2882846,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"WithdrawTokensForce","header":581355449,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"Withdraw","header":195467089,"fields":[{"name":"amount","type":{"kind":"simple","type":"uint","optional":false,"format":"coins"}}]},
    {"name":"PublickUnlockState","header":2953017186,"fields":[{"name":"newState","type":{"kind":"simple","type":"bool","optional":false}}]},
    {"name":"PresaleMaster$Data","header":null,"fields":[{"name":"owner","type":{"kind":"simple","type":"address","optional":false}},{"name":"stopped","type":{"kind":"simple","type":"bool","optional":false}},{"name":"my_jetton_wallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"my_usdt_wallet","type":{"kind":"simple","type":"address","optional":false}},{"name":"plans","type":{"kind":"dict","key":"uint","keyFormat":8,"value":"PlanInfo","valueFormat":"ref"}}]},
]

const JettonWallet_getters: ABIGetter[] = [
    {"name":"state","arguments":[],"returnType":{"kind":"simple","type":"bool","optional":false}},
...
const JettonWallet_receivers: ABIReceiver[] = [
    ...
    {"receiver":"internal","message":{"kind":"typed","type":"WalletOrder"}},
]
...
export class JettonWallet implements Contract {
    ...
    async send(provider: ContractProvider, via: Sender, args: { value: bigint, bounce?: boolean| null | undefined }, message: TokenTransfer | TokenTransferInternal | TokenBurn | WalletOrder) {
        ...
        if (message && typeof message === 'object' && !(message instanceof Slice) && message.$$type === 'WalletOrder') {
            body = beginCell().store(storeWalletOrder(message)).endCell();
        }
